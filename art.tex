...
\textbf{Average Precision (AP)} & 0,4600 & Precisão média ponderada na classe minoritária. \\
\textbf{Tempo de Inferência} & \textless{} 10ms & Tempo médio de resposta por amostra. \\
\bottomrule
\caption{Métricas globais de desempenho do classificador MLP.}
\end{longtable}
